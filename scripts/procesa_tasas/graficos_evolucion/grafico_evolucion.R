...
grafico(datos_rendimiento, "ARTES Y HUMANIDADES", "RENDIMIENTO", TRUE, 0.2)
dev.off()

png("graph/evolucion_rendimiento_ciencias.png", width=1221, height=1000, units='px')
grafico(datos_rendimiento, "CIENCIAS", "RENDIMIENTO", TRUE, 2.5)
dev.off()

png("graph/evolucion_rendimiento_salud.png", width=1221, height=1000, units='px')
grafico(datos_rendimiento, "CIENCIAS DE LA SALUD", "RENDIMIENTO", TRUE, 1.9)
dev.off()

png("graph/evolucion_rendimiento_sociales.png", width=1221, height=1000, units='px')
grafico(datos_rendimiento, "CIENCIAS SOCIALES Y JURÍDICAS", "RENDIMIENTO", TRUE, 0.2)
dev.off()

png("graph/evolucion_rendimiento_ingenieria.png", width=1221, height=1000, units='px')
grafico(datos_rendimiento, "INGENIERÍA Y ARQUITECTURA", "RENDIMIENTO", TRUE, 0.3)
dev.off()
...
grafico(datos_abandono_inicial, "ARTES Y HUMANIDADES", "ABANDONO INICIAL", FALSE, 0.2)
dev.off()

png("graph/evolucion_abandono_inicial_ciencias.png", width=1221, height=1000, units='px')
grafico(datos_abandono_inicial, "CIENCIAS", "ABANDONO INICIAL", FALSE, 2.5)
dev.off()

png("graph/evolucion_abandono_inicial_salud.png", width=1221, height=1000, units='px')
grafico(datos_abandono_inicial, "CIENCIAS DE LA SALUD", "ABANDONO INICIAL", FALSE, 1.8)
dev.off()
...
grafico(datos_abandono_inicial, "INGENIERÍA Y ARQUITECTURA", "ABANDONO INICIAL", FALSE, 0.3)
dev.off()